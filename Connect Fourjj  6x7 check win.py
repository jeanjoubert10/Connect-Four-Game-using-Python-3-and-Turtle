...
# This was kept as simple as possible
# Jean Joubert 10 Nov 2019
# Written in IDLE
# sound using os and afplay (mac), aplay linux, windsound for windows or # code

import turtle
import numpy as np
import os # for sound in mac OS/linux, use winsound in windows
...
def four_in_row(board,piece):
    ...
    for c in range(4): # Can't get 4 in row in the last 3 cols
        for r in range(7):
            if board[r][c] == piece and board[r][c+1]==piece and board[r][c+2]==piece and board[r][c+3]==piece:
                return True

    # Vertical 
    for c in range(7): # Can't get 4 in row in the last 3 cols
        for r in range(4):
